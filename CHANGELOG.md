...
* Fixed Android manual quality persistence so reconnect and live-edge recovery now reapply the user-selected quality instead of falling back to auto selection.
